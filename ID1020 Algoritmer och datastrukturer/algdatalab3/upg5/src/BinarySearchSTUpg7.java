 ...
 */
public class BinarySearchSTUpg7<Key extends Comparable<Key>, Value>
{
     ...
     */
    public BinarySearchSTUpg7(int capacity)
    {
    ...
    public Iterable<Key> keys(Key lo, Key hi)
    {
        ...
        QueueUpg7<Key> queueUpg7 = new QueueUpg7<>();
        if(lo.compareTo(hi) > 0) return queueUpg7;
        for(int i = rank(lo); i < rank(hi); i++)
            queueUpg7.enqueue(keys[i]);
        if(contains(hi)) queueUpg7.enqueue(keys[rank(hi)]);
        return queueUpg7;
    }
    ...
    /**
     * Unit tests the {@code BinarySearchSTUpg7} data type.
     *
     * @param args the command-line arguments
     */
    public static void main(String[] args)
    {
        /*BinarySearchSTUpg7<String, Integer> st = new BinarySearchSTUpg7<String, Integer>();
