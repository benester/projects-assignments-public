...
public class RedBlackLiteBSTUpg6<Key extends Comparable<Key>, Value> {

    private static final boolean RED   = true;
    private static final boolean BLACK = false;

    private Node root;     // root of the BSTUpg6
    private int n;         // number of key-value pairs in BSTUpg6

    // BSTUpg6 helper node data type
    private class Node {
        private Key key;           // key
    ...
    private void keys(Node x, QueueUpg6<Key> queueUpg6) {
        if (x == null) return;
        keys(x.left, queueUpg6);
        queueUpg6.enqueue(x.key);
        keys(x.right, queueUpg6);
    }
